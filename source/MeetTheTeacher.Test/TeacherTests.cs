...
namespace MeetTheTeacher.Test
{
    ...
    public class TeacherTests
    {
        ...
        {
            // Arrange
            Teacher teacher = new Teacher("TeacherA", "MO", "6. EH", "10:00-10:50", "3", "1234");
            // Act
        ...
        {
            // Arrange
            TeacherWithDetail teacher = new TeacherWithDetail("TeacherA", "MO", "6. EH", "10:00-10:50", "3", "1234", 999);
            // Act
            string html = teacher.GetHtmlForName();
            // Assert
